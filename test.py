...
def get_info_from_api(team_name):
    ...
    if "Everton" in team_name:     # some teams has different names than in sofa-score
        team_name = "brighton"
    if "Everton Newcastle United Placar ao vivo" in team_name:
        team_name = "leicester"
...
get_info_from_api("https://www.sofascore.com/pt")
